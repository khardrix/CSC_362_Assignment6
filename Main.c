 ...
 *****-------------------------------------------------------------------------------------------------------------------------------*****
 *****                                                 Program #6: Bin Packing Problem                                               *****
 *****_______________________________________________________________________________________________________________________________*****
 *****                   This program is used to make linkedLists of Structs and to solve the Bin Packing Problem.                   *****
 *****       There is also methods to insert items in the bins linkedLists in alphabetical order (if they fit into that bin),        *****
 *****        to traverse the bins and linkedLists, to print the linkedLists and bins and to destroy the bins and linkedLists.       *****
 *****************************************************************************************************************************************/
...
C:\Users\15136\source\repos\Huffman_Ryan_CSC_362_Assignment_6\Debug\Huffman_Ryan_CSC_362_Assignment_6.exe (process 12588) exited with code 0.
...
C:\Users\15136\source\repos\Huffman_Ryan_CSC_362_Assignment_6\Debug\Huffman_Ryan_CSC_362_Assignment_6.exe (process 3736) exited with code 0.
To automatically close the console when debugging stops, enable Tools->Options->Debugging->Automatically close the console when debugging stops.
Press any key to close this window . . .
*/